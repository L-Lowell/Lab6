...
```
###Now I have the model evaluations, I can run them through a test to see what I will move forward with:
...
###I will move forward with recipe_nnet_model as that was the most accurate.
...
```{r}
final_nnet_wf_4 <- workflow() %>%
  add_recipe(rec_4) %>%
  add_model(nnet_model_4) %>%
